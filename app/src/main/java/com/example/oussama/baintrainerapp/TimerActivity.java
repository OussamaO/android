...
public class TimerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scoreTextView = (TextView) findViewById(R.id.textScore);
    ...
    private void startTimer()
    {
        new CountDownTimer(30000 + 100 , 1000)
        {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                timeTextView.setText(String.valueOf(seconden));
            }
    ...
    private void maakSom()
    {
        ...
        TextView somTextView = (TextView) findViewById(R.id.textSom);
        ...
        for (int i = 0; i < buttons.length; i++)
        {
            if (i != goedeAntwoordKnop)
            {
                ...
                while (foutAntwoord == goedeAntwoordKnop)
                {
